...
const RoundImage = ({ src, image = src, className = '', color = '#000', ...props }) => {
  var randomColor = Math.floor(Math.random() * 16777215).toString(16);

  return image ? (
    <img src={image} alt="profile-logo" className={`${className} img-fluid`} {...props} />
  ) : (
    <svg
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g data-name="Layer 2" id="Layer_2">
          ...
          <g data-name="—ÎÓÈ 1" id="_ÎÓÈ_1">
            {' '}
            <circle cx="30.8999" cy="30.8999" fill={randomColor} r="30.8999" />{' '}
            <path d="M23.255 38.68l15.907.121v12.918l-15.907-.121V38.68z" fill="#f9dca4" fillRule="evenodd" />{' '}
            <path d="M43.971 58.905a30.967 30.967 0 0 1-25.843.14V48.417H43.97z" fill="#c9c9c9" fillRule="evenodd" />{' '}
